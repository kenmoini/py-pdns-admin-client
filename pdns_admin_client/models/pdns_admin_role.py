...
class PDNSAdminRole(BaseModel):
    """
    Roles of PowerDNS Admin
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID for this PDNSAdmin role")
    name: Optional[StrictStr] = Field(default=None, description="The Name of PDNSAdmin role")
