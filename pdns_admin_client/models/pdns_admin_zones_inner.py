...
class PDNSAdminZonesInner(BaseModel):
    """
    PDNSAdminZonesInner
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The ID for this PDNSAdmin zone")
    name: Optional[StrictStr] = Field(default=None, description="Name of the zone")
