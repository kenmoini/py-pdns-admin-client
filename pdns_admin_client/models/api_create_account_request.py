...
class ApiCreateAccountRequest(BaseModel):
    """
    ApiCreateAccountRequest
    """ # noqa: E501
    name: StrictStr = Field(description="Name for account (unique, immutable)")
    ...
    mail: Optional[StrictStr] = Field(default=None, description="Email address for contact")
    __properties: ClassVar[List[str]] = ["name", "description", "contact", "mail"]
