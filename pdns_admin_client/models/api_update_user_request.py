...
class ApiUpdateUserRequest(BaseModel):
    """
    ApiUpdateUserRequest
    """ # noqa: E501
    username: Optional[StrictStr] = Field(default=None, description="Login name for user (unique, immutable)")
    ...
    email: Optional[StrictStr] = Field(default=None, description="Email address if user (must be unique)")
    ...
    role_id: Optional[StrictStr] = Field(default=None, description="Role id of role to be assigned to user")
